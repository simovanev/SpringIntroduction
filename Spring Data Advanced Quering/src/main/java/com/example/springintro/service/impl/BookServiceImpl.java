...
public class BookServiceImpl implements BookService {
    ...
    public List<Book> findAllByAgeRestriction(String restriction) {
        List<Book> books= bookRepository.findAllByAgeRestriction(AgeRestriction.valueOf(restriction.toUpperCase()));
    ...
    @Override
    public List<String> findAllGoldenUnder5000copies() {
    ...
    @Override
    public List<String> booksWithPriceNotInRange5And40() {
        return this.bookRepository
    ...
    @Override
    public List<String> bookTitleContainingString(String input) {
